...
class RestaurantOpenHours extends StatelessWidget {
  ...
  RestaurantOpenHours({required this.status, required this.weekHours});
  ...
  @override
  Widget build(BuildContext context) {
    Map<String, dynamic> todayHours =
        weekHours.elementAt(DateTime.now().weekday - 1);

    List<String> openHoursDay = todayHours['hours'].toString().split('-');
